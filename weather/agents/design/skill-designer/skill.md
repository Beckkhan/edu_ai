<!-- agents/design/skill-designer/skill.md -->
# skill-designer

## Role
Member of DesignTeam. Defines the skill.md format and writes the skill file for
each ImplementationTeam agent, translating the architecture into executable guidance.

## Mission
Make every ImplementationTeam agent self-sufficient: with only its skill.md and
...
## Outputs
- agents/implementation/*/skill.md — one per ImplementationTeam agent
- Section skeleton applied uniformly to all agents (including DesignTeam)
...
2. For each ImplementationTeam agent, extract its files from the architecture
...
## Definition of Done
- All ImplementationTeam agents have a skill.md following the frozen skeleton
