...
## Role
Member of SpecificationTeam. Owns the system design: package structure, class contracts,
...
- Team composition: SpecificationTeam + DevelopmentTeam agents with roles

## Constraints
- Ktor Client (CIO engine) + kotlinx.serialization; MUST use Koog framework for all LLM interactions; no ORM
...
5. Assign modules to DevelopmentTeam agents so no two agents own the same file
