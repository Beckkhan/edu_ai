...
- [ ] T1 | owner: SpecificationTeam/skill-designer | artifact: agents/development/{koog-engineer,api-client-engineer,logging-engineer,kotlin-engineer,data-engineer,core-engineer}/skill.md | status: pending | verified: -
...
- [ ] T2 | owner: DevelopmentTeam/koog-engineer | artifact: src/main/resources/tools/save_weather.json | status: pending | verified: -
...
- [ ] T3 | owner: DevelopmentTeam/koog-engineer | artifact: src/main/kotlin/com/eduai/weather/client/deepseek/WeatherAgent.kt, src/main/kotlin/com/eduai/weather/tool/SaveWeatherTool.kt | status: pending | verified: -
  - deps: T2
...
- [ ] T4 | owner: DevelopmentTeam/logging-engineer | artifact: src/main/kotlin/com/eduai/weather/logging/RequestLogger.kt | status: pending | verified: -
...
- [ ] T5 | owner: DevelopmentTeam/koog-engineer | artifact: src/main/kotlin/com/eduai/weather/client/deepseek/WeatherAgent.kt | status: pending | verified: -
  - deps: T3, T4
...
- [ ] T6 | owner: DevelopmentTeam/api-client-engineer | artifact: src/main/kotlin/com/eduai/weather/routes/ChatRoutes.kt | status: pending | verified: -
  - deps: T4
  - acceptance: ChatRoutes emits "Request from Bruno to backend" and "Response to Bruno" lines via RequestLogger, with json bodies

- [ ] T7 | owner: DevelopmentTeam/kotlin-engineer | artifact: src/main/kotlin/com/eduai/weather/service/ChatService.kt, src/main/kotlin/com/eduai/weather/Application.kt | status: pending | verified: -
  - deps: T3, T5
...
- [ ] T8 | owner: DevelopmentTeam/data-engineer | artifact: src/main/kotlin/com/eduai/weather/db/WeatherLogRepository.kt | status: pending | verified: -
...
- [ ] T9 | owner: DevelopmentTeam/koog-engineer | artifact: src/main/kotlin/com/eduai/weather/tool/SaveWeatherTool.kt | status: pending | verified: -
  - deps: T3, T8
...
- [ ] T10 | owner: QualityTeam/unit-test-engineer | artifact: src/test/kotlin/com/eduai/weather/service/ChatServiceTest.kt | status: pending | verified: -
  - deps: T7
  - acceptance: ChatService tests pass with WeatherAgent mocked; no direct tool-call path remains testable; no network, no DB

- [ ] T11 | owner: QualityTeam/unit-test-engineer | artifact: src/test/kotlin/com/eduai/weather/logging/RequestLoggerTest.kt | status: pending | verified: -
  - deps: T4
  - acceptance: unit tests assert the exact five-line R2 format and secret redaction

- [ ] T12 | owner: QualityTeam/integration-test-engineer | artifact: src/test/kotlin/com/eduai/weather/db/WeatherLogRepositoryTest.kt | status: pending | verified: -
  - deps: T8
  - acceptance: tests pass against docker compose up postgres; received_at round-trips without loss

- [ ] T13 | owner: QualityTeam/reviewer | artifact: final scenario run (Bruno request against the running app) | status: pending | verified: -
